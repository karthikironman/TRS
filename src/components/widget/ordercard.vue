...
.inner-order-card {
  ...
  border-radius: 7px;
  background: transparent linear-gradient(277deg, #ffffff 0%, #bbecff 100%) 0%
...
.address{
text-align: center;
font: Regular 23px/31px Segoe UI;
letter-spacing: 0px;
color: #040D33;
opacity: 1;
position:absolute;
